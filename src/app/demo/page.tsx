...
export const metadata: Metadata = {
  ...
  description: "Verify RuleWallet's live policy account, autonomous receipt, simulator, and operator controls without using real funds.",
};
