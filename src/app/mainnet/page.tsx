...
export const metadata: Metadata = {
  ...
  description: "Experimental, unaudited RuleWallet V2 onboarding for Robinhood Chain mainnet.",
};
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-5 py-12 lg:px-8">
        <div className="flex flex-wrap items-end justify-between gap-5">
          <div>
            <Badge variant="outline" className="border-red-400/30 text-red-200">Experimental · unaudited · real assets</Badge>
            <h1 className="mt-5 text-4xl font-semibold tracking-tight sm:text-5xl">Robinhood Chain mainnet control center</h1>
            <p className="mt-4 max-w-3xl text-lg leading-8 text-muted-foreground">Deploy a personal V2 policy account, configure bounded agent authority, and inspect every owner-signed transaction before it reaches your wallet.</p>
          </div>
