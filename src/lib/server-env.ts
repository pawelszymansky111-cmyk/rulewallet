...
const serverEnvironmentSchema = z.object({
  ...
  MAINNET_STRATEGY_ENCRYPTION_KEY: z.string().regex(/^[a-fA-F0-9]{64}$/).optional(),
  COMMERCE_SESSION_SECRET: z.string().regex(/^[a-fA-F0-9]{64}$/).optional(),
  COMMERCE_DATA_ENCRYPTION_KEY: z.string().regex(/^[a-fA-F0-9]{64}$/).optional(),
  ...
  MAINNET_ALERT_WEBHOOK_SIGNING_SECRET: z.string().regex(/^[a-fA-F0-9]{64}$/).optional(),
  TESTNET_NOTIFICATION_WEBHOOK_URL: z.url().optional(),
  TESTNET_NOTIFICATION_WEBHOOK_TOKEN: z.string().min(16).optional(),
  TESTNET_NOTIFICATION_WEBHOOK_SIGNING_SECRET: z.string().regex(/^[a-fA-F0-9]{64}$/).optional(),
...
export function getServerEnvironment(): ServerEnvironment {
  if (!cachedEnvironment) {
    cachedEnvironment = serverEnvironmentSchema.parse({
      ...
      MAINNET_STRATEGY_ENCRYPTION_KEY: process.env.MAINNET_STRATEGY_ENCRYPTION_KEY || undefined,
      COMMERCE_SESSION_SECRET: process.env.COMMERCE_SESSION_SECRET || undefined,
      COMMERCE_DATA_ENCRYPTION_KEY: process.env.COMMERCE_DATA_ENCRYPTION_KEY || undefined,
      ...
      MAINNET_ALERT_WEBHOOK_SIGNING_SECRET: process.env.MAINNET_ALERT_WEBHOOK_SIGNING_SECRET || undefined,
      TESTNET_NOTIFICATION_WEBHOOK_URL: process.env.TESTNET_NOTIFICATION_WEBHOOK_URL || undefined,
      TESTNET_NOTIFICATION_WEBHOOK_TOKEN: process.env.TESTNET_NOTIFICATION_WEBHOOK_TOKEN || undefined,
      TESTNET_NOTIFICATION_WEBHOOK_SIGNING_SECRET: process.env.TESTNET_NOTIFICATION_WEBHOOK_SIGNING_SECRET || undefined,
